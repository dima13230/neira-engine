    ...
    class Launcher
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            using (GameLogic NeiraEngine = new GameLogic())
            {
                //string version = GL.GetString(StringName.Version);
                //if (version.Substring(0, 3) == ClientConfig.gl_version_string)
                //{
                Debug.logInfo(0, ClientConfig.title);
