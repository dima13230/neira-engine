...
namespace NativeOpenGL
{
    public class fx_DepthOfField : RenderEffect
    {
        ...
        public fx_DepthOfField(string resource_folder_name, Resolution full_resolution)
        ...
        protected override void load_Programs()
        {
            ...
            _pAutoFocus = ProgramLoader.createProgram(new ShaderFile[]
            {
            ...
            _pCOC = ProgramLoader.createProgram_PostProcessing(new ShaderFile[]
            {
            ...
            _pCOC_Fix = ProgramLoader.createProgram_PostProcessing(new ShaderFile[]
            {
                new ShaderFile(ShaderType.FragmentShader, _path_glsl_effect + "dof_COC_Fix.frag", null)
            });
            _pCOC_Fix.enable_Samplers(2);

            _pCOC_Combine = ProgramLoader.createProgram_PostProcessing(new ShaderFile[]
            {
            ...
            _pBokeh_Reset = ProgramLoader.createProgram(new ShaderFile[]
            {
                new ShaderFile(ShaderType.ComputeShader, _path_glsl_effect + "dof_Bokeh_Reset.comp", null)
            });

            _pBokeh_Extract = ProgramLoader.createProgram_PostProcessing(new ShaderFile[]
            {
            ...
            _pBokeh_Render = ProgramLoader.createProgram(new ShaderFile[]
            {
            ...
            //_pDOF_Blur = ProgramLoader.createProgram_PostProcessing(new ShaderFile[]
            //{
            //    new ShaderFile(ShaderType.FragmentShader, _path_glsl_effect + "dof_DOF_Blur.frag", null)
            //});
            _pDOF_Blur = ProgramLoader.createProgram(new ShaderFile[]
            {
            ...
            _pDOF_Blend = ProgramLoader.createProgram_PostProcessing(new ShaderFile[]
            {
        ...
        protected override void load_Buffers()
        {
            ...
            // Bokeh
            //------------------------------------------------------
            _iBokehShape = StaticImageLoader.createImage(_path_static_textures + "bokeh_circle.png", TextureTarget.Texture2D, TextureWrapMode.Clamp, true);
