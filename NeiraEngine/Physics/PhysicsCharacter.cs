...
namespace NeiraEngine.Physics
{
    class PhysicsCharacter
    {
        ...
        public PhysicsCharacter(Vector3 start_position, float size)
        {
            ...
            PhysicsWorld.world.Broadphase.OverlappingPairCache.SetInternalGhostPairCallback(new GhostPairCallback());
            ...
            character.Gravity = -PhysicsWorld.world.Gravity.Y * 1.0f;
            character.MaxSlope = OpenTK.MathHelper.DegreesToRadians(50.0f);
            character.SetUseGhostSweepTest(true);


            PhysicsWorld.world.AddCollisionObject(ghostObject, CollisionFilterGroups.CharacterFilter, CollisionFilterGroups.StaticFilter | CollisionFilterGroups.DefaultFilter);
            PhysicsWorld.collision_shapes.Add(capsule);
            PhysicsWorld.world.AddAction(character);
        }
