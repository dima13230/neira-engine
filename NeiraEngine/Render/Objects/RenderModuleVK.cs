...
{
    public class RenderModuleVK : RenderModule
    {

        public RenderModuleVK(Resolution res)
            : base(res)
        {

        }

        /*public ngl.UniformBuffer ubo_game_config = new ngl.UniformBuffer(ngl.BufferStorageFlags.DynamicStorageBit, 0, new EngineHelper.size[]
            {
                EngineHelper.size.vec4,
                EngineHelper.size.f
            });

        public ngl.UniformBuffer ubo_camera = new ngl.UniformBuffer(ngl.BufferStorageFlags.DynamicStorageBit, 1, new EngineHelper.size[] {
