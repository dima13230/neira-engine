...
namespace NeiraEngine.Output
{
    class Audio
    {
        ...
        public void playSound(Vector3 l_position, Vector3 l_dir, Vector3 l_up)
        {
            ...
            OpenTK.Vector3 s_pos = new Vector3(0.0f, 0.0f, 0.0f);
            OpenTK.Vector3 s_vel = new Vector3(0.0f, 0.0f, 0.0f);
            OpenTK.Vector3 s_dir = -s_pos;
            ...
            OpenTK.Vector3 s_temp_p;
            OpenTK.Vector3 s_temp_v;
            OpenTK.Vector3 s_temp_d;
            ...
            OpenTK.Vector3 l_vel = new Vector3();
            OpenTK.Vector3 L_dir = -l_dir;

            OpenTK.Vector3 l_pos = l_position;
            OpenTK.Vector3 l_upp = l_up;

            AL.Listener(ALListener3f.Position, ref l_pos);
            AL.Listener(ALListenerfv.Orientation, ref L_dir, ref l_upp);
            AL.Listener(ALListener3f.Velocity, ref l_vel);
            OpenTK.Vector3 l_temp_p;
            OpenTK.Vector3 l_temp_l;
            OpenTK.Vector3 l_temp_u;
