...
namespace Cgen.Audio
{
    ...
    public class Sound : SoundBuffer
    {
        ...
        public void Play()
        {
            ...
            // Triger the event
            SoundStarted?.Invoke(this, EventArgs.Empty);
        }
        ...
        public void Pause()
        {
            ...
            if (State != SoundState.Paused)
            {
                ...
                SoundPaused?.Invoke(this, EventArgs.Empty);
            }
        }
        ...
        public void Resume()
        {
            ...
            if (State == SoundState.Paused)
            {
                ...
                SoundResumed?.Invoke(this, EventArgs.Empty);
            }
        }
        ...
        public void Stop()
        {
            ...
            SoundStopped?.Invoke(this, EventArgs.Empty);
