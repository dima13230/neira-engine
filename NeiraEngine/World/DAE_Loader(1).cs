...
namespace NeiraEngine.World
{
    static class DAE_Loader
    {
        ...
        public static void load(string filename, MaterialManager material_manager, out Dictionary<string, UniqueMesh> unique_mesh_collection, out Dictionary<string, LightLoader.LightLoaderExtras> light_extras)
        {
            ...
            Grendgine_Collada dae_file = null;

            if (File.Exists(filename))
            {
                Debug.Debug.logInfo(1, "Loading Collada File", Path.GetFileName(filename));
                dae_file = Grendgine_Collada.Grendgine_Load_File(filename);
            }
            else if (Properties.Resources.ResourceManager.GetObject(filename) != null)
            {
                Debug.Debug.logInfo(1, "Loading Collada From Built-in", Path.GetFileName(filename));

                byte[] data = (byte[])Properties.Resources.ResourceManager.GetObject(filename);
                string str = "";
                foreach (byte b in data)
                    str += (char)b;

                dae_file = Grendgine_Collada.Grendgine_Load_String(str);
            }
            else
            {
                throw new Exception("Could not find DAE by given path in filesystem neither in built-in resources!");
            }
            ...
            try
            {
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Image Dictionary", dae_file.Library_Images.Image.Count() + " images found");
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Image Dictionary", "0 images found :<");
                }
            }
            catch (Exception e)
            {
                Debug.Debug.logError("\tCreating Image Dictionary", e.Message);
            }
            ...
            try
            {
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Material Dictionary", dae_file.Library_Effects.Effect.Count() + " effects found");
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Material Dictionary", "0 effects found :<");
                }
            }
            catch (Exception e)
            {
                Debug.Debug.logError("\tCreating Material Dictionary", e.Message);
            }
            ...
            try
            {
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Animation Dictionary", dae_file.Library_Animations.Animation.Count() + " animations found");
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Animation Dictionary", "0 animations found :<");
                }
            }
            catch (Exception e)
            {
                Debug.Debug.logError("\tCreating Animation Dictionary", e.Message);
            }
            ...
            //------------------------------------------------------
            Debug.Debug.logInfo(2, "\tCreating Visuals Dictionary", dae_file.Library_Visual_Scene.Visual_Scene[0].Node.Count() + " visuals found");
            ...
            foreach (Grendgine_Collada_Node node in dae_file.Library_Visual_Scene.Visual_Scene[0].Node)
            {
                ...
                // Convert Blender transformation to Neira
                ...
                Matrix4 temp_corrected_matrix = EngineHelper.blender2Neira(temp_matrix);

                // Skeletons
                if (node.node != null && node.node[0].Instance_Geometry == null)
                {
            ...
            try
            {
                ...
                {
                    Debug.Debug.logInfo(2, "\tLoading Skinning Data", dae_file.Library_Controllers.Controller.Count() + " skins found");
                ...
                {
                    Debug.Debug.logInfo(2, "\tLoading Skinning Data", "0 skins found :<");
                }
            }
            catch (Exception e)
            {
                Debug.Debug.logError("\tLoading Skinning Data", e.Message);
            }
            ...
            try
            {
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Mesh Dictionary", dae_file.Library_Geometries.Geometry.Count() + " meshes found");
                    foreach (Grendgine_Collada_Geometry g in dae_file.Library_Geometries.Geometry)
                    {
                        ...
                        {
                            Debug.Debug.logError("[ FAILED ] Loading Mesh: " + mesh_id, e.Message);
                            continue;
                        }
                ...
                {
                    Debug.Debug.logInfo(2, "\tCreating Mesh Dictionary", "0 meshes found :<");
                }
            }
            catch (Exception e)
            {
                Debug.Debug.logError("\tCreating Mesh Dictionary", e.Message);
            }
            ...
            // Create Mesh Visuals
            //------------------------------------------------------
            Debug.Debug.logInfo(2, "\tLoading Mesh Visuals", "");
            ...
            foreach (Grendgine_Collada_Node node in mesh_visual_collection)
            {
                ...
                Debug.Debug.logInfo(3, "\t\tLoading Visual Scene", visual_id);

                // Convert Blender transformation to Kailash
                Matrix4 temp_matrix = EngineHelper.blender2Neira(EngineHelper.createMatrix(
                    new Vector3(node.Translate[0].Value()[0], node.Translate[0].Value()[1], node.Translate[0].Value()[2]),
                    new Vector3(node.Rotate[2].Value()[3], node.Rotate[1].Value()[3], node.Rotate[0].Value()[3]),
                    new Vector3(node.Scale[0].Value()[0], node.Scale[0].Value()[1], node.Scale[0].Value()[2])
                ));
            ...
            // Create Skin Visuals
            //------------------------------------------------------
            Debug.Debug.logInfo(2, "\tLoading Controlled Visuals", "");
            foreach (Grendgine_Collada_Node node in controlled_visual_collection)
            {
                ...
                {
                    Debug.Debug.logInfo(3, "\t\tLoading Visual Scene", visual_id + " (" + controller_id + " )");
        ...
        public static int[] loadVAO(Mesh mesh)
        {
