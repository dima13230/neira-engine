...
namespace NeiraEngine.World
{
    public static class PrefabManager
    {
        ...
        public static WorldObject Load(string name)
        {
            ...
            Debug.Debug.logInfo(1, "Loading prefab...", name);
                    ...
                    if (line.Length != 0)
                    {
                        ...
                        switch (line.Substring(0, 4))
                        {
                            ...
                            case "par ":
                                ...
                                {
                                    Debug.Debug.logError("[ ERROR ] Couldn't set parameter! " + multi_value[0], "No any Component to set in!");
                                }
                                break;
                            case "cld ":
            ...
            {
                Debug.Debug.logError("[ ERROR ] Loading Prefab: " + filename, e.ToString());
                return null;
            }
        }
    }
