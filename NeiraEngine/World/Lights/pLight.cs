...
namespace NeiraEngine.World.Lights
{
    public class pLight : Light
    {
        ...
        public pLight(string id, Vector3 color, float intensity, float falloff, bool shadow, Mesh light_mesh, Matrix4 transformation, Scene scene = null)
            : base(id, scene, type_point, color, intensity, falloff, shadow, light_mesh, transformation)
        {
