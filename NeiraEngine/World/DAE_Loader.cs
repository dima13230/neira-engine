...
namespace NeiraEngine.World
{
    static class DAE_Loader
    {
        ...
        public static void load(string filename, MaterialManager material_manager, out Dictionary<string, UniqueMesh> unique_mesh_collection, out Dictionary<string, LightLoader.LightLoaderExtras> light_extras)
        {
            ...
            {
                Debug.logInfo(1, "Loading Collada File", Path.GetFileName(filename));
            ...
            {
                Debug.logInfo(1, "Loading Collada From Built-in", Path.GetFileName(filename));
            ...
            try
            {
                ...
                {
                    Debug.logInfo(2, "\tCreating Image Dictionary", dae_file.Library_Images.Image.Count() + " images found");
                ...
                {
                    Debug.logInfo(2, "\tCreating Image Dictionary", "0 images found :<");
                }
            }
            catch (Exception e)
            {
                Debug.logError("\tCreating Image Dictionary", e.Message);
            }
            ...
            try
            {
                ...
                {
                    Debug.logInfo(2, "\tCreating Material Dictionary", dae_file.Library_Effects.Effect.Count() + " effects found");
                ...
                {
                    Debug.logInfo(2, "\tCreating Material Dictionary", "0 effects found :<");
                }
            }
            catch (Exception e)
            {
                Debug.logError("\tCreating Material Dictionary", e.Message);
            }
            ...
            try
            {
                ...
                {
                    Debug.logInfo(2, "\tCreating Animation Dictionary", dae_file.Library_Animations.Animation.Count() + " animations found");
                ...
                {
                    Debug.logInfo(2, "\tCreating Animation Dictionary", "0 animations found :<");
                }
            }
            catch (Exception e)
            {
                Debug.logError("\tCreating Animation Dictionary", e.Message);
            }
            ...
            //------------------------------------------------------
            Debug.logInfo(2, "\tCreating Visuals Dictionary", dae_file.Library_Visual_Scene.Visual_Scene[0].Node.Count() + " visuals found");
            ...
            try
            {
                ...
                {
                    Debug.logInfo(2, "\tLoading Skinning Data", dae_file.Library_Controllers.Controller.Count() + " skins found");
                ...
                {
                    Debug.logInfo(2, "\tLoading Skinning Data", "0 skins found :<");
                }
            }
            catch (Exception e)
            {
                Debug.logError("\tLoading Skinning Data", e.Message);
            }
            ...
            try
            {
                ...
                {
                    Debug.logInfo(2, "\tCreating Mesh Dictionary", dae_file.Library_Geometries.Geometry.Count() + " meshes found");
                    foreach (Grendgine_Collada_Geometry g in dae_file.Library_Geometries.Geometry)
                    {
                        ...
                        {
                            Debug.logError("[ FAILED ] Loading Mesh: " + mesh_id, e.Message);
                            continue;
                        }
                ...
                {
                    Debug.logInfo(2, "\tCreating Mesh Dictionary", "0 meshes found :<");
                }
            }
            catch (Exception e)
            {
                Debug.logError("\tCreating Mesh Dictionary", e.Message);
            }
            ...
            // Create Mesh Visuals
            //------------------------------------------------------
            Debug.logInfo(2, "\tLoading Mesh Visuals", "");
            ...
            foreach (Grendgine_Collada_Node node in mesh_visual_collection)
            {
                ...
                Debug.logInfo(3, "\t\tLoading Visual Scene", visual_id);
            ...
            // Create Skin Visuals
            //------------------------------------------------------
            Debug.logInfo(2, "\tLoading Controlled Visuals", "");
            foreach (Grendgine_Collada_Node node in controlled_visual_collection)
            {
                ...
                {
                    Debug.logInfo(3, "\t\tLoading Visual Scene", visual_id + " (" + controller_id + " )");
