    ...
    class DAE_Material : Material
    {
        ...
        public void load(Grendgine_Collada_Effect effect, Dictionary<string, string> image_collection, MaterialManager material_manager)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception(Debug.Debug.format("\t\tDiffuse Texture", "File Not Found"));
                }
            }
            catch
            {
            ...
            try
            {
                ...
                {
                    throw new Exception(Debug.Debug.format("\t\tSpecular Texture", "File Not Found"));
                }
            }
            catch
            {
            ...
            try
            {
                ...
                {
                    throw new Exception(Debug.Debug.format("\t\tNormal Texture", "File Not Found"));
                }
            }
            catch
            { }
            ...
            try
            {
                ...
                {
                    throw new Exception(Debug.Debug.format("\t\tDisplacement Texture", "File Not Found"));
                }
            }
            catch
            { }
            ...
            try
            {
                ...
                {
                    throw new Exception(Debug.Debug.format("\t\tParallax Texture", "File Not Found"));
                }
            }
            catch
            { }
